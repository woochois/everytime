					...
					<div class="panel panel-default">
						...
						<div id="newArticle" class="panel-collapse collapse"
							...
							<div class="panel-body">
								<div>									 
									<input type="hidden" name="pnickname" value="${member.nickname}" /><br/>
...
4. 기타 약관 및 현행법에 어긋나는 행위"></textarea>
			...
			<c:forEach var="promotionBoardList" items="${promotionBoardList}">
				<article>
					<a class="article" href="/promotionBoardListView/pbno/${promotionBoardList.pbno}/pageNum/${pb.currentPage}">
						<h2 class="medium">${promotionBoardList.ptitle }</h2>
						<p class="small">${promotionBoardList.pcontents }</p> 
						<time class="small">${promotionBoardList.pregdate }</time>
