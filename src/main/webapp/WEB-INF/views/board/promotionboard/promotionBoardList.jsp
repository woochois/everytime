...
<body>
	...
	<div id="submenu">
		<div class="wrap">
			...
			<div class="group">
				<ul>
					<li><a href="../freeboard/freeBoardList" data-id="389131"
	...
	<div id="container" class="article">
		...
		<aside class="none">
			<div class="title">
				<a class="hamburger"></a>
				<h1>
					<a href="/promotionBoardList">홍보게시판</a>
				</h1>
			</div>
		</aside>
		...
		<div class="wrap articles">
			...
			<form action="/pbinsert" class="write">
...
4. 기타 약관 및 현행법에 어긋나는 행위"></textarea>
			...
			<c:forEach var="promotionBoardList" items="${promotionBoardList}">
				<article>
					<a class="article"
						href="/promotionBoardListView/pbno/${promotionBoardList.pbno}/pageNum/${pb.currentPage}">
			...
			<!-- search -->
			<form action="/promotionBoardList/pageNum/1" method="get">
				<select name="search">
				...
				<ul class="pagination">
					<c:if test="${pb.startPage > pb.pagePerBlock}">
						<li class="page-item"><a class="page-link"
							href="/promotionBoardList/pageNum/1?search=${promotionboard.search}&keyword=${promotionboard.keyword}">
						...
						<li class="page-item"><a class="page-link"
							href="/promotionBoardList/pageNum/${pb.startPage-1}?search=${promotionboard.search}&keyword=${promotionboard.keyword}">
								<svg width="1em" height="1em" viewBox="0 0 16 16"
					...
					<c:forEach var="i" begin="${pb.startPage}" end="${pb.endPage}">
						<c:if test="${i==pb.currentPage}">
							<li class="active page-item"><a class="page-link"
								href="/promotionBoardList/pageNum/${i}?search=${promotionboard.search}&keyword=${promotionboard.keyword}">${i}</a></li>
						</c:if>
						<c:if test="${i!=pb.currentPage}">
							<li class="page-item"><a class="page-link"
								href="/promotionBoardList/pageNum/${i}?search=${promotionboard.search}&keyword=${promotionboard.keyword}">${i}</a></li>
					...
					<c:if test="${pb.endPage < pb.totalPage }">
						<li class="page-item"><a class="page-link"
							href="/promotionBoardList/pageNum/${pb.endPage+1}?search=${promotionboard.search}&keyword=${promotionboard.keyword}">
								<svg width="1em" height="1em" viewBox="0 0 16 16"
						...
						<li class="page-item"><a class="page-link"
							href="/promotionBoardList/pageNum/${pb.totalPage}?search=${promotionboard.search}&keyword=${promotionboard.keyword}">
								<svg width="1em" height="1em" viewBox="0 0 16 16"
